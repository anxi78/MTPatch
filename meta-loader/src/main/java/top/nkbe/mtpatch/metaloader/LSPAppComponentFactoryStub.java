package top.nkbe.mtpatch.metaloader;
...
public class LSPAppComponentFactoryStub extends AppComponentFactory {
    ...
    private static final String TAG = "MTPatch-MetaLoader";
    ...
    static {
        ...
        if (appZygote) {
            Log.i(TAG, "Skip loading libmtpatch.so for appZygote");
        } else {
            bootstrap();
        }
    }
    ...
    private static void bootstrap() {
        try {
            ...
            if (useManager) {
                ...
                soAssetPath = "assets/mtpatch/so/" + libName + "/libmtpatch.so";
            } else {
            ...
            try (var is = soSourceApk != null
                ...
                if (is == null) {
                    throw new RuntimeException("Should not happen: libmtpatch.so not found in assets");
                }
    ...
    private static File createTempSoFile(int currentUserId) throws IOException {
        ...
        return File.createTempFile("libmtpatch-", ".so", baseDir);
    }
